...
/** @fileoverview The feature vocabulary shared by authoring, snapshots, and the canvas. */
...
export function observationsFor(
  ...
  return kind === undefined
    ? [...new Set(Object.values(table).flat())]
    : table[kind];
}
...
export const EXPLANATIONS: Readonly<Record<string, string>> = {
  ...
  greater_zero:
    'The feature is above zero \u2014 the usual guard on a countdown.',
