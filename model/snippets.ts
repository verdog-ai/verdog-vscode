...
function subroutineBody() {
  return JSON.stringify(
    emptySubroutine('${1:subroutine}', '${2:Subroutine}'),
    undefined,
    2,
  );
}
...
const SNIPPETS = {
  nodes: [
    ...
    },
    {
      ...
      documentation:
        'Calls a lexically visible subroutine definition in this process.',
    },
    {
      label: 'workflow call',
      ...
      documentation:
        'Calls a lexically visible local or external workflow definition in its own process.',
    },
  ],
  features: [
    {
  ...
  "options": {
    ...
    "extra_args": []
      ...
      documentation:
        'A concrete agent profile with its provider invocation options.',
    },
  ],
  session_parameters: [
    {
  ...
  sessions: [
    {
      ...
      documentation:
        "A local agent session used by this subroutine's agent nodes.",
    },
  ],
  edges: [
    {
  ...
  conditions: [
    ...
    },
    {
      ...
      documentation:
        'Requires an enum feature to have one of its declared values.',
    },
  ],
  effects: [
    {
  ...
  workflows: [
    ...
    },
    {
      ...
      documentation:
        'Binds a definition name in this scope to a workflow from a direct pin.',
    },
  ],
  subroutines: [
    {
      ...
      body: subroutineBody(),
      documentation:
        'Defines a nested subroutine with a complete pass-through body.',
    },
  ],
