...
/** @fileoverview Python keywords, which Verdog identifiers and package components may not use. */
...
export function entityLabel(collection: string): string {
  return collection.replaceAll('_', ' ').replace(/s$/, '');
}
