...
/** @fileoverview Resolve README links without granting a publisher command/file URI authority. */
export function documentationHref(
  ...
  try {
    ...
    return resolved.origin === 'https://github.com' &&
      resolved.href.startsWith(root)
      ? resolved.toString()
      : undefined;
  }
}
